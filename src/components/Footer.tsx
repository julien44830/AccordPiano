            ...
            <div className="mx-auto max-w-6xl px-4 py-10 grid gap-4 md:grid-cols-2 relative">
                ...
                <div>
                    ...
                    <p className="mt-2 text-gray-700">
                        Basée dans le<strong> vignoble nantais</strong>,
                        j’interviens dans toute la
                        <strong> Loire-Atlantique</strong> (Nantes,
                        Saint-Herblain, Rezé, Orvault, Oudon, Vallet...) et les
                        <strong> départements limitrophes</strong>.
                        <br />
